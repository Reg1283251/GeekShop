...
<script type="text/javascript">
	function delFromCart(pid) {
		if (confirm("您确定要从购物车删除此商品吗")) {
			//跳转到后台,根据pid删除商品
			window.location = "${pageContext.request.contextPath}/product?method=delFromCart&pid="
					+ pid;
		}
	}
	...
	<div class="container">
						...
						<c:forEach items="${cart.cartitem}" var="entry">
							<tr class="active">
								...
								<td><a href="javascript:;"
									onclick="delFromCart('${entry.value.product.pid}')"
		...
		<div style="margin-right: 130px;">
			...
			<div
				...
				<a href="order_info.htm"> <input type="submit" width="100"
