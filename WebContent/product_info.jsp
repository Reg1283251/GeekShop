...
<script>
	function addCart() {
		...
		var pid = ${product.pid};
		//跳转路经
		window.location = "${pageContext.request.contextPath}/product?method=addCart&pid="
				+ pid + "&count=" + count;
	}
</script>
	...
	<div class="container">
		<div class="row">
			<div
				...
				<a
					href="${pageContext.request.contextPath}/product?method=productListByCid&cid=${product.cid}&currentPage=1">首页&nbsp;&nbsp;&gt;</a>
				<a
					href="${pageContext.request.contextPath}/product?method=productListByCid&cid=${product.cid}&currentPage=${currentPage}">${category.cname}</a>
			</div>
			...
			<div style="margin: 0 auto; width: 950px;">
				...
				<div class="col-md-6">
					...
					<div style="margin: 10px 0 10px 0;">
						亿家价: <strong style="color: #ef0101;">￥：${product.shop_price}元</strong>
						参 考 价：
